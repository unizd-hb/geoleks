...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3765',
            //extent: [242711.840395, 4670796.854384, 731566.001653, 5157273.724853],
            units: 'm'
        })
    })
});
...
map.getView().fit([300820.824988, 4943336.477446, 445680.199988, 5054858.352446], map.getSize());
